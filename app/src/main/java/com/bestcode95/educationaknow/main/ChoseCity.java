...
import com.bestcode95.educationaknow.utils.adapter.MyAdapter;
import com.bestcode95.educationaknow.utils.database.DBManager;
...
public class ChoseCity extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        sureBt = (Button) findViewById(R.id.chose_city_sure_bt);
        ...
        sureBt.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(ChoseCity.this, MainActivity.class);
...
//            Toast.makeText(ChoseCity.this, province + " " + city + " " + district, Toast.LENGTH_LONG).show();
        }
